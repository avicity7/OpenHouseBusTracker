        ...
        <tbody class="bg-white divide-y divide-gray-200">
          {#each Object.entries(groupedData) as [key, value]}
            <tr class="hover:bg-gray-100">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                <div class="flex items-center">
                  <a href={`event-helper/update-helper/${encodeURIComponent(JSON.stringify({ Carplate: key.split('_')[0], Shift: value.shift }))}`} class="text-slate-500 hover:text-green-500 mr-8">
                    <ToolTip text="Update Event Helper">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M7 7H6a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2-2v-1M20.385 6.585a2.1 2.1 0 0 0-2.97-2.97L9 12v3h3zM16 5l3 3"/>
                      </svg>
                  ...
                  <button class="text-slate-500 hover:text-red-600 text-2xl" on:click={() => deleteEventHelper({ Carplate: key.split('_')[0], Shift: value.shift })}>
                    <ToolTip text="Delete Event Helper"> 
                      <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...$$props}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...$$props}>
                          <g fill="none">
