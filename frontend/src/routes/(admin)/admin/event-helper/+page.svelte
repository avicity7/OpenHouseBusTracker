<script lang="ts">
	...
	function applyFilters() {
		filteredHelpers = eventHelper.filter((helper) => {
			...
			const matchesShift =
				selectedShift === '' || (selectedShift === 'AM' ? helper.Shift : !helper.Shift);
...
<div class="p-6 md:p-12">
	...
	<div class="flex w-full justify-end my-4">
		<a href="event-helper/swaps" class="text-gray-400 hover:text-red-600">View swaps</a>
	</div>
							...
							<td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
								<div class="flex items-center">
									<a
										...
										data-testid="update-helper-{helper}"
									>
